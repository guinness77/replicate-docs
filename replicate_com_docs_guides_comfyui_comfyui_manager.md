...
## [Anchor for install-the-comfyui-manager](https://replicate.com/docs/guides/comfyui/comfyui-manager\#install-the-comfyui-manager) Install the ComfyUI manager
...
## [Anchor for start-installing-models-and-nodes](https://replicate.com/docs/guides/comfyui/comfyui-manager\#start-installing-models-and-nodes) Start installing models and nodes
...
[Next:Start by running the ComfyUI examples](https://replicate.com/docs/guides/comfyui/examples)
