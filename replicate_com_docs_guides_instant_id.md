...
![InstantID](https://replicate.com/frontend-assets/instantidcover-BK1LVlaX.png)
...
## [Anchor for run-instantid-in-our-playground](https://replicate.com/docs/guides/instant-id\#run-instantid-in-our-playground) Run InstantID in our Playground
...
[Next:Run InstantID with an API](https://replicate.com/docs/guides/instant-id/run-instant-id-with-an-api)
