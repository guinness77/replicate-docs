...
## [Anchor for run-whisperx-in-our-playground](https://replicate.com/docs/guides/whisper\#run-whisperx-in-our-playground) Run WhisperX in our Playground
...
[Next:Run WhisperX with an API](https://replicate.com/docs/guides/whisper/run-whisperx-with-an-api)
