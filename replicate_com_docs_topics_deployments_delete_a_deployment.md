...
## [Anchor for delete-a-deployment-on-the-web](https://replicate.com/docs/topics/deployments/delete-a-deployment\#delete-a-deployment-on-the-web) Delete a deployment on the web
...
## [Anchor for delete-a-deployment-via-api](https://replicate.com/docs/topics/deployments/delete-a-deployment\#delete-a-deployment-via-api) Delete a deployment via API
