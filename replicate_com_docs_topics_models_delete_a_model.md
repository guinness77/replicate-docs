...
This guide covers how to delete a model you've created, as well as how to delete [model versions](https://replicate.com/docs/topics/models/versions).

## [Anchor for delete-a-model](https://replicate.com/docs/topics/models/delete-a-model\#delete-a-model) Delete a model
...
- You can only delete models that have no versions associated with them. You'll need to [delete any versions first](https://replicate.com/docs/topics/models/delete-a-model#delete-a-model-version) before deleting the model.

### [Anchor for delete-a-model-on-the-web](https://replicate.com/docs/topics/models/delete-a-model\#delete-a-model-on-the-web) Delete a model on the web

Go to your model page, navigate to **Settings**, then select **Delete model**.

### [Anchor for delete-a-model-via-api](https://replicate.com/docs/topics/models/delete-a-model\#delete-a-model-via-api) Delete a model via API
...
## [Anchor for delete-a-model-version](https://replicate.com/docs/topics/models/delete-a-model\#delete-a-model-version) Delete a model version
...
- You cannot delete a version if it has an associated [deployment](https://replicate.com/docs/topics/deployments).

### [Anchor for delete-a-model-version-on-the-web](https://replicate.com/docs/topics/models/delete-a-model\#delete-a-model-version-on-the-web) Delete a model version on the web

Go to your model page, navigate to the **Versions** tab, select a version, then select **Delete**.

### [Anchor for delete-a-model-version-via-api](https://replicate.com/docs/topics/models/delete-a-model\#delete-a-model-version-via-api) Delete a model version via API
