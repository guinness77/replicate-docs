...
Whether your model is [public or private](https://replicate.com/docs/topics/models/private-models), or running as a [deployment](https://replicate.com/docs/topics/deployments), you can change the hardware it runs on.

To compare hardware pricing and performance, see the [pricing page](https://replicate.com/pricing).

## [Anchor for edit-model-hardware-on-the-web](https://replicate.com/docs/topics/models/hardware\#edit-model-hardware-on-the-web) Edit model hardware on the web
...
## [Anchor for edit-model-hardware-using-the-api](https://replicate.com/docs/topics/models/hardware\#edit-model-hardware-using-the-api) Edit model hardware using the API
...
## [Anchor for edit-deployment-hardware-on-the-web](https://replicate.com/docs/topics/models/hardware\#edit-deployment-hardware-on-the-web) Edit deployment hardware on the web

If you're running a [deployment](https://replicate.com/docs/topics/deployments), you can change its hardware configuration using the web or the API.
...
## [Anchor for edit-deployment-hardware-using-the-api](https://replicate.com/docs/topics/models/hardware\#edit-deployment-hardware-using-the-api) Edit deployment hardware using the API
...
## [Anchor for hardware-for-fine-tunes](https://replicate.com/docs/topics/models/hardware\#hardware-for-fine-tunes) Hardware for fine-tunes

Fine-tuned models based on SDXL or Flux with [fast booting](https://replicate.com/docs/billing#fast-booting-models) use the hardware set by the base model they were trained from.

If you would like to change the hardware for a version with fast booting, you can [make a deployment](https://replicate.com/deployments/create).

[Next:Private models vs. public models](https://replicate.com/docs/topics/models/private-models)
