...
When [creating a model on Replicate](https://replicate.com/docs/topics/models/create-a-model), you can choose whether to make it public or private.

You can create a private model on your personal account, and it will only be visible to you. You can also create a private model in an [organization](https://replicate.com/docs/topics/organizations) to share it with members of your team.

## [Anchor for making-a-private-model-public](https://replicate.com/docs/topics/models/private-models\#making-a-private-model-public) Making a private model public
...
## [Anchor for making-a-public-model-private](https://replicate.com/docs/topics/models/private-models\#making-a-public-model-private) Making a public model private
...
[Next:Use a model as a training destination](https://replicate.com/docs/topics/models/models-as-training-destinations)
