...
## [Anchor for automatic-data-clean-up](https://replicate.com/docs/topics/predictions/data-retention\#automatic-data-clean-up) Automatic data clean up

For predictions created through the API, all input parameters, output values, output files, and logs are automatically removed after an hour, by default. If you'd like to continue using the prediction input and output data, you must save your own copies before it is removed. For tips on how to store prediction data, refer to the [webhooks docs](https://replicate.com/docs/topics/webhooks).
...
## [Anchor for deleting-predictions-manually](https://replicate.com/docs/topics/predictions/data-retention\#deleting-predictions-manually) Deleting predictions manually
...
[Next:Streaming output](https://replicate.com/docs/topics/predictions/streaming)
