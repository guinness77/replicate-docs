...
- You can [create predictions](https://replicate.com/docs/reference/http#create-a-prediction) at 600 requests per minute.
...
[Next:Safety checking](https://replicate.com/docs/topics/predictions/safety-checking)
