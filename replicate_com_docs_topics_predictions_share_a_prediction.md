...
Every [prediction](https://replicate.com/docs/topics/predictions) that you create is associated with your user account, and only you can see the predictions that you create.
...
[![Share button](https://replicate.com/frontend-assets/share-button-Czh4d4aV.webp)](https://replicate.com/black-forest-labs/flux-schnell/examples)

[Next:Rate limits](https://replicate.com/docs/topics/predictions/rate-limits)
